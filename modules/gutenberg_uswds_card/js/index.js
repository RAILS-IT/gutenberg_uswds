...
var Toolbar = components.Toolbar,
  ...
  __experimentalInputControl = components.__experimentalInputControl;
...
var card = {
  ...
  edit: function edit(_ref) {
    ...
    var layout = attributes.layout,
      ...
      titleAtTop = attributes.titleAtTop,
      insetMedia = attributes.insetMedia,
      mediaOnRight = attributes.mediaOnRight;
    ...
    var getMediaEntity = function () {
      var _ref2 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(item) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch(Drupal.url("gutenberg_uswds_card/media/load-media/".concat(item)));
            case 2:
      ...
      return function getMediaEntity(_x) {
        return _ref2.apply(this, arguments);
      };
    }();
    var insertMedia = function insertMedia(mediaEntityId) {
      if (isNaN(mediaEntityId)) {
        var regex = /\((\d*)\)$/;
        var match = regex.exec(mediaEntityId);
        mediaEntityId = match[1];
      }
      getMediaEntity(mediaEntityId).then(function (media) {
        setAttributes({
    ...
    return React.createElement(Fragment, null, React.createElement("div", {
      className: "".concat(className, " usa-card tablet:grid-col ") + (titleAtTop ? 'usa-card--header-first' : '') + (layout == 'flag' ? 'usa-card--flag ' : '') + (mediaOnRight ? 'usa-card--media-right' : '')
      ...
      className: "usa-card__media " + (insetMedia ? 'usa-card__media--inset' : '')
    }, React.createElement("div", {
      className: "usa-card__img"
    }, mediaEntityId ? React.createElement("img", {
      src: mediaEntity.media_details.sizes.large.source_url,
      className: "image"
    }) : isSelected && React.createElement(MediaUpload, {
      ...
      withoutInteractiveFormatting: true,
      allowedFormats: []
    }), isSelected && React.createElement(Fragment, null, React.createElement(Flex, {
      className: "button-link"
    }, React.createElement(FlexItem, null, React.createElement(Dashicon, {
      icon: "admin-links"
    })), React.createElement(FlexBlock, null, React.createElement(__experimentalInputControl, {
      value: buttonUrl,
    ...
    }), layout === 'flag' && !mediaEntityId && React.createElement(Notice, {
      status: "error",
      isDismissible: false
    }, React.createElement("p", null, __('Media is required when flag layout is selected.')))), React.createElement(PanelBody, {
    ...
    }), showButton && React.createElement(ToggleControl, {
      label: __('Open link in new tab'),
      checked: buttonOpenNewTab,
      onChange: function onChange() {
        return setAttributes({
          buttonOpenNewTab: !buttonOpenNewTab
        });
      }
    })), mediaEntityId && layout == "default" && React.createElement(PanelBody, {
      title: __('Default Layout - Media Settings')
    }, React.createElement(ToggleControl, {
      label: __('Title at top'),
      checked: titleAtTop,
      onChange: function onChange() {
        return setAttributes({
          titleAtTop: !titleAtTop
        });
      }
    }), React.createElement(ToggleControl, {
    ...
    })), mediaEntityId && layout == "flag" && React.createElement(PanelBody, {
      title: __('Flag Layout - Media Settings')
    }, React.createElement(ToggleControl, {
    ...
    }))), mediaEntityId && React.createElement(BlockControls, null, React.createElement(Toolbar, {
      controls: [{
        icon: 'no',
...
registerBlockType("".concat(category.slug, "/card"), _objectSpread({
